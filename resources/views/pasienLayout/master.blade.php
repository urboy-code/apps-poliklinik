        ...
        <aside class="main-sidebar elevation-4" style="background-color: #1D267D">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="background-color: #1D267D">
                    ...
                    <div class="info">
                        <a href="#" class="d-block text-white fw-bold">Pasien 1</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('daftar.index') }}" class="nav-link text-white fw-bold">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('daftarPoli.index') }}" class="nav-link text-white fw-bold">
