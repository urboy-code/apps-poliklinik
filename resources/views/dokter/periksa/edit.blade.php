            ...
            <div class="card-body">
                <form action="{{route('jadwal_periksa.update', $periksa->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama" value="{{$periksa->nama}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control" name="mulai" value="{{$periksa->mulai}}">
                    </div>
                    <div class="form-group">
                        <label for="" class="form-label">Jam Selesai</label>
                        <input type="time" class="form-control" name="selesai" value="{{$periksa->selesai}}">
                    </div>
